...
export default function About() {
  return <Box sx={{ marginLeft: '5px', padding: '1em', }}>
      ...
      <Typography>
        After you've pasted the output of a command you'll get a table containing the data.
        You can explore different columns by clicking
          on <Button startIcon={<ViewColumnIcon />}>
          Columns
        </Button>, or try filtering/sorting the columns.
      </Typography>
